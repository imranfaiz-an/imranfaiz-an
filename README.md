...
- [CAPP 122 Project - Chi-Ed](https://github.com/uchicago-2026-capp30122/project-chi-ed) *(in progress)*
  - Final project for CAPP 122 CS course where I am working with a team of 2 more members to analyze and map highschool educational outcomes for over 170 hishschools in Chicago. For the project I have written modules to fetch [Chicago Public Schools API](https://api.cps.edu/) JSON data, clean and synthesize different different data sources and work on the builind of an interactive dashboard to visualize the results.
